...
const SvgAdvantageIllustration = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 510 415" {...props}>
    ...
    />
    <path
      fill="url(#advantage__illustration_svg__b)"
      d="M155.267 258.334c11.207-7.782 55.489-21.8 74.937-27.837l20.575 2.245c12.964 3.214 40.77 8.693 53.561 13.879 12.791 5.185 36.003 21.722 57.658 35.512l-5.113 17.708a50.146 50.146 0 0 1-32.453 33.706c-4.045 25.722-7.533 67.539-6.957 80.503l-150.486-.117-6.889-63.648-30.989 3.32-26.177-20.058c32.777-56.694 38.325-65.485 52.333-75.213Z"
    />
    <path
      fill="url(#advantage__illustration_svg__c)"
    ...
    >
      <path
        fill="url(#advantage__illustration_svg__e)"
        d="m217.906 248.011 3.63-36.149h35.345l4.068 36.222c-1.419 4.257-8.142 12.821-20.549 12.821-15.812 0-21.481-8.637-22.494-12.894Z"
      />
    </mask>
    <g mask="url(#advantage__illustration_svg__f)">
      <path
        fill="#000"
    ...
    <path
      fill="url(#advantage__illustration_svg__g)"
      d="M238.574 226.374c-38.117 0-44.672-54.715-32.895-79.741 26.498-32.387 59.622-13.495 72.871 0 3.19 20.855 6.707 79.741-39.976 79.741Z"
    />
    <path
      fill="#111"
      d="m279.201 184.516-7.468-5.501 1.155-4.096 8.53 5.625-2.217 3.972ZM201.396 182.921l7.468-5.502-1.155-4.095-8.53 5.624 2.217 3.973Z"
    />
    <path
      fill="#30235B"
      d="M208.23 149.921c27.023 17.607 56.982 7.336 68.583 0-2.443 7.704 1.018 22.513 3.053 28.954 17.584-22.898 11.835-35.263 6.763-38.584-.845-11.412-11.22-39.946-46.049-38.594-34.829 1.353-41.588 26.055-40.601 35.213-13.188 17.922-5.342 35.444 1.019 41.965 7.232-14.04 7.067-23.889 7.232-28.954Z"
    />
    <g filter="url(#advantage__illustration_svg__h)">
      <path
        fill="#fff"
        d="M243.348 119.318c-40.343-1.35-49.329 25.181-50.535 40.587-.097 1.234-1.106 2.205-2.343 2.205-1.321 0-2.373-1.1-2.255-2.415 1.76-19.754 12.292-54.273 55.133-51.893 43.256 2.403 51.718 36.838 50.391 56.034-.071 1.027-.939 1.803-1.969 1.803-1.123 0-2.024-.911-2.069-2.033-.636-15.927-11.224-43.27-46.353-44.288Z"
      />
    </g>
    ...
    <g mask="url(#advantage__illustration_svg__m)">
      <path fill="#E8E8E8" d="m189.305 158.316 21.6-3.847 8.331 46.781-21.6 3.847z" />
    </g>
    <mask
    ...
    <g mask="url(#advantage__illustration_svg__n)">
      <path fill="#E8E8E8" d="m291.748 158.316-21.6-3.847-8.331 46.781 21.6 3.847z" />
    </g>
    <path
      fill="#E6FCFF"
    ...
    <path
      fill="#111"
      fillRule="evenodd"
      d="M234.147 175.01c-8.794-7.723-16.738-4.455-21.445-2.519-.523.216-1.007.414-1.447.58l-2.947.005a1 1 0 0 0-.998 1.009l.022 2.478a1 1 0 0 0 1 .991h2.131c-1.544 13.251 8.228 16.797 16.043 14.408 6.968-2.129 8.833-8.154 9.206-11.934 1.49-3.303 8.024-1.777 8.283-.074l.02.134c.307 2.074 1.852 12.523 13.615 12.537 9.635.012 12.248-8.595 12.35-12.901l2.495-.022a1 1 0 0 0 .991-1.009l-.027-3.031a1 1 0 0 0-1.009-.991l-2.494.022c-6.276-6.358-19.758-5.763-24.507.217-5.239-1.208-9.704-.436-11.282.1Zm-11.998 15.897c-5.392 0-8.108-4.25-8.798-6.147-.793-1.587-1.42-5.722.459-9.007 2.389-4.176 13.618-5.341 17.552.559 3.933 5.9 0 14.595-9.213 14.595Zm44.53-6.147c-.69 1.897-3.405 6.147-8.798 6.147-9.212 0-13.145-8.695-9.212-14.595s15.163-4.735 17.552-.559c1.879 3.285 1.252 7.42.458 9.007Z"
      clipRule="evenodd"
    />
    <path
      fill="#B4B4B4"
    ...
    <path
      ...
      fillRule="evenodd"
      d="M130.715 169.875c.2-3.408.879-6.262 1.446-7.848a26.687 26.687 0 0 1 1.848 7.889c2.436.185 5.107.736 7.888 1.848-1.586.567-4.439 1.246-7.848 1.446-.19 3.618-1.12 6.43-1.888 7.87-.935-2.617-1.362-5.308-1.473-7.843-2.535-.112-5.227-.538-7.844-1.473 1.441-.768 4.252-1.698 7.871-1.889Z"
      clipRule="evenodd"
    />
    <path
      fill="url(#advantage__illustration_svg__q)"
      fillRule="evenodd"
      d="M103.828 147.449c.132-2.269.585-4.169.962-5.224a17.766 17.766 0 0 1 1.23 5.25c1.621.124 3.399.49 5.251 1.231-1.056.377-2.955.829-5.224.962-.127 2.409-.746 4.28-1.257 5.239-.623-1.742-.906-3.534-.98-5.221-1.688-.074-3.48-.358-5.222-.98.96-.511 2.831-1.131 5.24-1.257Z"
      clipRule="evenodd"
    />
    <path
      fill="url(#advantage__illustration_svg__r)"
      fillRule="evenodd"
      d="M60.504 131.471c.2-3.409.88-6.262 1.446-7.848a26.66 26.66 0 0 1 1.848 7.888c2.436.186 5.107.736 7.889 1.849-1.586.566-4.44 1.246-7.848 1.445-.19 3.619-1.121 6.431-1.89 7.871-.934-2.617-1.36-5.309-1.472-7.844-2.535-.111-5.226-.538-7.843-1.472 1.44-.768 4.252-1.699 7.87-1.889Z"
      clipRule="evenodd"
    />
    <path
      fill="url(#advantage__illustration_svg__s)"
      fillRule="evenodd"
    ...
    />
    <path
      fill="url(#advantage__illustration_svg__t)"
      fillRule="evenodd"
      d="M348.065 169.875c-.199-3.408-.879-6.262-1.445-7.848a26.66 26.66 0 0 0-1.849 7.889 26.643 26.643 0 0 0-7.888 1.848c1.586.567 4.439 1.246 7.848 1.446.19 3.618 1.12 6.43 1.889 7.87.934-2.617 1.361-5.308 1.472-7.843 2.535-.112 5.227-.538 7.844-1.473-1.44-.768-4.252-1.698-7.871-1.889Z"
      clipRule="evenodd"
    />
    <path
      fill="url(#advantage__illustration_svg__u)"
      fillRule="evenodd"
      d="M374.953 147.449c-.133-2.269-.585-4.169-.962-5.224a17.739 17.739 0 0 0-1.231 5.25c-1.621.124-3.399.49-5.251 1.231 1.056.377 2.955.829 5.224.962.127 2.409.746 4.28 1.258 5.239.622-1.742.905-3.534.98-5.221 1.687-.074 3.479-.358 5.221-.98-.959-.511-2.831-1.131-5.239-1.257Z"
      clipRule="evenodd"
    />
    <path
      fill="url(#advantage__illustration_svg__v)"
      fillRule="evenodd"
      d="M418.276 131.471c-.2-3.409-.879-6.262-1.446-7.848a26.681 26.681 0 0 0-1.848 7.888 26.66 26.66 0 0 0-7.889 1.849c1.586.566 4.44 1.246 7.849 1.445.19 3.619 1.12 6.431 1.888 7.871.935-2.617 1.361-5.309 1.473-7.844 2.535-.111 5.227-.538 7.843-1.472-1.44-.768-4.251-1.699-7.87-1.889Z"
      clipRule="evenodd"
    />
    <path
      fill="url(#advantage__illustration_svg__w)"
      fillRule="evenodd"
...
export default SvgAdvantageIllustration;
